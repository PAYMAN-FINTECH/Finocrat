...
import { TravelAuthService } from '../../../services/travelservices/travel-auth.service';
  ...
  template: `
    <header class="fastag-header">
      <div class="container">
        ...
        <!-- <nav class="nav-links">
          <a routerLink="/travel" routerLinkActive="active">Recharge</a>
          <a routerLink="/travel/history" routerLinkActive="active">History</a>
          <a routerLink="/travel/support" routerLinkActive="active">Support</a>
        </nav> -->
...
export class TravelHeader implements OnInit {
